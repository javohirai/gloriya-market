...
public class ReqShippingInTransit
{
    public static String[] send(String tpCode)
    {
        final String soapAction = "http://www.sample-package.org#MobileAgents:ShippingInTransit";
        final String methodName = "ShippingInTransit";
        ...
        request.addProperty("DateOfDeparture", new SimpleDateFormat("yyyyMMddHHmmss", Locale.getDefault()).format(new Date(System.currentTimeMillis())));
