...
public class ReqCompleteShippingDelivered
{
    public static String[] send(String tpCode, String orderNumb, String orderDate)
    {
        final String soapAction = "http://www.sample-package.org#MobileAgents:CompleteShippingDelivered";
        final String methodName = "CompleteShippingDelivered";
