...
public class ReqPriceList
{
    ...
    {
        final String soapAction = "http://www.sample-package.org#MobileAgents:GetPriceList";
        final String methodName = "GetPriceList";
        ...
        try
        {
            ...
            AppDB.getInstance(context).addPrice(response);
        }
        catch (Exception ex)
        {
            L.exception(">>> EXCEPTION: loadPriceList 1 <<<");
            ex.printStackTrace();
        }
    }
}