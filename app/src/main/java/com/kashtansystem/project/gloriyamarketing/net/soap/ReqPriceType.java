...
public class ReqPriceType
{
    public static void load(Context context)
    {
        final String soapAction = "http://www.sample-package.org#MobileAgents:GetPriceTypes";
        final String methodName = "GetPriceTypes";
        ...
        try
        {
            ...
            AppDB.getInstance(context).savePriceType(response);
        }
        catch (Exception ex)
        {
