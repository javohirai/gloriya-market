...
public class CanceledOrdersForReceivingAdapter extends BaseExpandableListAdapter
{
    private View.OnClickListener listener;
    private LayoutInflater layoutInflater;
    private List<PackageTemplate> items;

    public CanceledOrdersForReceivingAdapter(Context context, View.OnClickListener listener)
    {
    ...
    {
        if (convertView == null)
            convertView = layoutInflater.inflate(R.layout.canceled_orders_for_receiving_group_item, null);

        final PackageTemplate item = items.get(groupPosition);

        ((TextView)convertView.findViewById(R.id.tvCncOrdDeliveryDate)).setText(item.getDeliveryDate());
        ((TextView)convertView.findViewById(R.id.tvCncOrdCustomer)).setText(item.getCustomer());
        ((TextView)convertView.findViewById(R.id.tvCncOrdTotalCapacity)).setText(String.format("%s", item.getCapacity()));
        ((TextView)convertView.findViewById(R.id.tvCncOrdTotalWeight)).setText(String.format("%s", item.getWeight()));
        ((TextView)convertView.findViewById(R.id.tvCncOrdForwarder)).setText(item.getPackerName());
        ((TextView)convertView.findViewById(R.id.tvCncOrdStatus)).setText("Отменён");

        View view = convertView.findViewById(R.id.btnCncOrdComplete);
