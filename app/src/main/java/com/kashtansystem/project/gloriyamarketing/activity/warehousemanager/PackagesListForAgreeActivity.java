...
import com.kashtansystem.project.gloriyamarketing.adapters.PackagesListForAgreeAdapter;
 ...
 * ----------------------------------
 * Заказы, собранные сборщиком. Здесь зав.склада должен подтвердить сборку того или иного сборщика
 */

public class PackagesListForAgreeActivity extends BaseActivity implements View.OnClickListener,
    OnDialogBtnsClickListener
{
    private PackagesListForAgreeAdapter adapter;

    @Override
    public String getActionBarTitle()
    {
        return getString(R.string.label_packages_for_agree);
    }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        adapter = new PackagesListForAgreeAdapter(this, this);
        ...
        packageTemplate.setPackerName("Антон Шур");
        ...
        packageTemplate2.setPackerName("Ахмедов Рустам");
